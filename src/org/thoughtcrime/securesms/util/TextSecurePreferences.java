...
public class TextSecurePreferences {
  ...
  private static final String ACCOUNT_NAME_PREF                = "pref_account_name";
  ...
  public static void setAccountName(Context context, String name) {
    setStringPreference(context, ACCOUNT_NAME_PREF, name);
  }

  public static String getAccountName(Context context) {
    return getStringPreference(context, ACCOUNT_NAME_PREF, null);
  }
  ...
  public static String getKVNR(Context context) {
    return getStringPreference(context, LOCAL_NUMBER_PREF, null);
  }

  public static void setKVNR(Context context, String localNumber) {
