...
public class ContactAccessor {
        ...
        Cursor cursor = cr.query(ContactsContract.Contacts.CONTENT_URI,null, null, null, null);
            while (cursor != null && cursor.moveToNext()) {
                ...
                while (cur1.moveToNext()) {
                    ...
                    if (email != null && !TextUtils.isEmpty(cursor.getString(0))) {
                        results.add(Address.fromExternal(context, email));
                    }
                }
                cur1.close();
        }
    ...
    public Cursor getAllSystemContacts(Context context) {
        ...
        while (cursor != null && cursor.moveToNext()) {
            ...
            while (cur1.moveToNext()) {
                String number = cur1.getString(cur1.getColumnIndex(ContactsContract.CommonDataKinds.Email.DATA));
                ...
                String contactPhotoUri = cur1.getString(cur1.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.PHOTO_URI));
                String contactLabel = cur1.getString(cur1.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.LABEL));
                Uri contactUri = ContactsContract.Contacts.getLookupUri(cur1.getLong(cur1.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone._ID)),
                        cur1.getString(cur1.getColumnIndexOrThrow(ContactsContract.CommonDataKinds.Phone.LOOKUP_KEY)));
        ...
        /*return context.getContentResolver().query(Phone.CONTENT_URI, new String[] {
                Phone.NUMBER, Phone.DISPLAY_NAME, Phone.LABEL, Phone.PHOTO_URI, Phone._ID, Phone.LOOKUP_KEY},
                null, null, null);*/
    }
