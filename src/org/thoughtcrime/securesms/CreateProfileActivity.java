...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private void initializeProfileAvatar(boolean excludeSystem) {
    Address ourAddress = Address.fromSerialized(TextSecurePreferences.getKVNR(this));
    ...
    new AsyncTask<Void, Void, Boolean>() {
      ...
      protected Boolean doInBackground(Void... params) {
        ...
        try {
          ...
          AvatarHelper.setAvatar(CreateProfileActivity.this, Address.fromSerialized(TextSecurePreferences.getKVNR(context)), avatarBytes);
